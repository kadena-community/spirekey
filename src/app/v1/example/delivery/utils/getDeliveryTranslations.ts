import focus from '@/app/v1/example/delivery/icons/mono_center_focus_strong.svg';
import done from '@/app/v1/example/delivery/icons/mono_download_done.svg';
import check from '@/app/v1/example/delivery/icons/mono_fact_check.svg';
import add from '@/app/v1/example/delivery/icons/mono_playlist_add.svg';
import deliver from '@/app/v1/example/delivery/icons/mono_view_in_ar.svg';
