      ...
      const tx = await asyncPipe(
        composePactCommand(
          ...
          addSigner(
            ...
            // @ts-expect-error Argument of type '((withCap: IGeneralCapability) => any) | undefined' is not assignable to parameter of type '(withCapability: IGeneralCapability) => ICap[]'.
