...
describe('TrackerCard', () => {
    ...
    test('renders correctly', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: labelValue, variant: "vertical", helperText: "helper text", helperTextType: "mild", icon: "QuickStart" }));
    ...
    test('displays correct content', () => {
        render(React.createElement(TrackerCard, { labelValues: labelValue, variant: "vertical", helperText: "helper text", helperTextType: "mild", icon: "QuickStart" }));
    ...
    test('icons and value not in document', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: labelValue.splice(0, 1), variant: "vertical", helperText: "helper text", helperTextType: "mild", icon: undefined }));
    ...
    test('masked value not in document', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: labelValue.splice(-1), variant: "vertical", helperText: "helper text", helperTextType: "mild", icon: "QuickStart" }));
        const labelValueContainer = getByTestId('kda-label-value-container-0');
        const label = getByTestId('kda-label-0');
    ...
    test('empty labelValue prop and helper text results in no label-value containers and no helper text', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: [], variant: "vertical", icon: "QuickStart" }));
        const trackerCard = getByTestId('kda-tracker-card');
        const icon = getByTestId('kda-icon');
        const dataContainer = getByTestId('kda-data-container');
        expect(trackerCard).toBeInTheDocument();
    ...
    test('no more label-value containers than necessary', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: labelValue, variant: "horizontal", helperText: "helper text", helperTextType: "mild", icon: "QuickStart" }));
        const firstLabelValueContainer = getByTestId('kda-label-value-container-0');
        const secondLabelValueContainer = getByTestId('kda-label-value-container-1');
        expect(firstLabelValueContainer).toBeInTheDocument();
        expect(secondLabelValueContainer).toBeInTheDocument();
    ...
    test('masked value should not be masked when default visible is true', () => {
        const { getByTestId } = render(React.createElement(TrackerCard, { labelValues: [
                {
                    label: 'Account',
                    value: 'k:1234567890abcdef',
                    isAccount: true,
