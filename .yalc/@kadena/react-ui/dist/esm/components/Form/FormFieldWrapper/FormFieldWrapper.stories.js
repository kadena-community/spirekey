...
export const Group = {
    ...
    render: ({ disabled, status, tag, helperText, info, label, leadingTextWidth, }) => {
        return (React.createElement(FormFieldWrapper, { tag: tag, info: info, label: label, leadingTextWidth: leadingTextWidth, status: status, disabled: disabled, helperText: helperText, htmlFor: "inputStory" },
