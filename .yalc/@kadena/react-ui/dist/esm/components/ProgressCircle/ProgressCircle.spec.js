...
describe('ProgressCircle', () => {
    it('Should handle defaults', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress" }));
    ...
    it('Should handle indeterminate', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", isIndeterminate: true }));
        const progressCircle = getByRole('progressbar');
        expect(progressCircle).toHaveAttribute('aria-valuemin', '0');
        expect(progressCircle).toHaveAttribute('aria-valuemax', '100');
    ...
    it('Should handle controlled value', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", value: 30 }));
        const progressCircle = getByRole('progressbar');
        expect(progressCircle).toHaveAttribute('aria-valuemin', '0');
        expect(progressCircle).toHaveAttribute('aria-valuemax', '100');
    ...
    it('Should clamp values to 0', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", value: -1 }));
        const progressCircle = getByRole('progressbar');
        expect(progressCircle).toHaveAttribute('aria-valuenow', '0');
    });
    it('Should clamp values to 100', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", value: 1000 }));
        const progressCircle = getByRole('progressbar');
        expect(progressCircle).toHaveAttribute('aria-valuenow', '100');
    });
    it('Should support className', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", className: "testClass" }));
        const progressCircle = getByRole('progressbar');
    ...
    it('can handle negative values with minValue and maxValue', () => {
        const { getByRole } = render(React.createElement(ProgressCircle, { "aria-label": "Progress", value: 0, minValue: -5, maxValue: 5 }));
    ...
    it('supports custom DOM props', () => {
        const { getByTestId } = render(React.createElement(ProgressCircle, { value: 25, "aria-label": "Progress", "data-testid": "test" }));
