...
export const Legend = ({ items }) => {
    return (React.createElement(Stack, { as: "ul", style: { listStyle: 'none', padding: 0 }, gap: "lg", position: "absolute", right: 0, bottom: 0, marginBlock: "sm", marginInline: "md" }, items.map(({ color, label }) => (React.createElement(Stack, { as: "li", key: label, alignItems: "center", gap: "sm" },
        React.createElement(Box, { style: { width: 15, height: 15 }, backgroundColor: `semantic.${color}.default`, borderColor: "base.bold", borderStyle: "solid", borderWidth: "hairline" }),
