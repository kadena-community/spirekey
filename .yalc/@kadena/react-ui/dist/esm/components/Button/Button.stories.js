...
const meta = {
    ...
    argTypes: {
        ...
        variant: {
            options: Object.keys(typeVariants),
            control: {
                type: 'select',
            },
...
export const Dynamic = {
    ...
    render: ({ active, as, color = 'primary', disabled, href, icon, iconAlign = 'right', loading, onClick, target, text, title, variant = 'default', }) => {
        ...
        return (React.createElement(Button, { active: active, as: as, color: color, disabled: disabled, href: href, icon: icon, iconAlign: iconAlign, loading: loading, onClick: onClick, target: target, title: title, variant: variant }, text));
    },
};
export default meta;
