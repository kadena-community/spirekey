...
describe('MaskedValue', () => {
    ...
    test('shows correct unmasked value', () => {
        render(React.createElement(MaskedValue, { value: "TestValue1234", defaultVisibility: true }));
    ...
    test('shows unmasked value when unmasked characters are greater or equal than value size', () => {
        render(React.createElement(MaskedValue, { value: "TestValue1234", startUnmaskedValues: 8, endUnmaskedValues: 5 }));
        expect(screen.getByText('TestValue1234')).toBeInTheDocument();
    });
});
