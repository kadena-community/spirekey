...
exports.TextareaField = (0, react_1.forwardRef)(function TextareaField({ disabled = false, id, status, tag, info, helperText, label, ...rest }, ref) {
    ...
    return (react_1.default.createElement("div", { className: statusVal ? FormFieldWrapper_css_1.statusVariant[statusVal] : undefined },
        ...
        react_1.default.createElement(Form_1.Textarea, { ref: ref, disabled: disabled, id: id, ...rest }),
