...
function BaseLinkButton(props, forwardedRef) {
    ...
    const { linkProps, isPressed } = (0, react_aria_1.useLink)(props, ref);
    ...
    return (react_1.default.createElement("a", { ...(0, utils_1.mergeProps)(linkProps, hoverProps, focusProps), ref: ref, className: (0, classnames_1.default)((0, SharedButton_css_1.button)({
...
exports.LinkButton = (0, react_1.forwardRef)(BaseLinkButton);
