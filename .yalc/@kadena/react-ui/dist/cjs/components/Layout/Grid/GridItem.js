...
const GridItem = ({ className, children, columnSpan, rowSpan = 1, }) => {
    return (react_1.default.createElement("div", { className: (0, classnames_1.default)(Grid_css_1.gridItemClass, Grid_css_1.rowSpanVariants[rowSpan], columnSpan && assembleColumnSpanVariants(columnSpan), className) }, children));
};
