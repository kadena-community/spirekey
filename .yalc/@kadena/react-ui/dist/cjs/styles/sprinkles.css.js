...
const responsiveProperties = (0, sprinkles_1.defineProperties)({
    ...
    properties: {
        ...
        marginBlock: vars_css_1.vars.sizes,
        marginInline: vars_css_1.vars.sizes,
        marginBlockStart: vars_css_1.vars.sizes,
        marginBlockEnd: vars_css_1.vars.sizes,
        marginInlineStart: vars_css_1.vars.sizes,
        marginInlineEnd: vars_css_1.vars.sizes,
        paddingBlock: vars_css_1.vars.sizes,
        paddingInline: vars_css_1.vars.sizes,
        paddingBlockStart: vars_css_1.vars.sizes,
        paddingBlockEnd: vars_css_1.vars.sizes,
        paddingInlineStart: vars_css_1.vars.sizes,
        paddingInlineEnd: vars_css_1.vars.sizes,
